...
void easy()
{
	...
	write << "Информация о пенсионерах с пенсионным стажем больше 5 лет " << endl;
	new_write << "Информация о пенсионерах с пенсионным стажем больше 5 лет " << endl;
	...
	if (count2 == 0)
	{
		write << "Нет пенсионеров с пенсионным стажем больше 5 лет";
...
int main()
{
	...
	do
	{
		cout << "Введите номер задания (easy - 1), (medium - 2): ";
